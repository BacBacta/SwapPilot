...
└─────────┘          └─────────┘          └─────────┘
     │                    │                    │
     ▼                    ▼                    ▼
 4 Protocols         10+ Protocols       All Major DEXs
     │                    │                    │
     ▼                    ▼                    ▼
  Basic UI            Mobile App          Full Suite
```
...
- **Bug Reports**: Report via GitHub
- **Translations**: Help localize SwapPilot
