...
export function SettingsDrawer({ open, onClose }: SettingsDrawerProps) {
  ...
  return createPortal(
    <>
      ...
      <div
        className={cn(
          "fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col transform border-l border-sp-lightBorder bg-sp-lightSurface shadow-soft transition-transform duration-base ease-standard",
